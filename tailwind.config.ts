...
export default {
	...
	theme: {
		extend: {
			...
			animation: {
				...
				'scale-out': 'scale-out 0.15s cubic-bezier(0.7, 0, 0.84, 0)',
				'slide-in-top': 'slide-in-top 0.2s cubic-bezier(0.16, 1, 0.3, 1)',
				'slide-out-top': 'slide-out-top 0.15s cubic-bezier(0.7, 0, 0.84, 0)'
			},
	...
	safelist: [
		{
			pattern: /bg-(?:muted|destructive|success)/,
			variants: ["hover"],
		},
		{
			pattern: /animate-(?:fade-in|fade-out|scale-in|scale-out|slide-in-top|slide-out-top)/,
		}
	],
